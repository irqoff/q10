...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_89(
        ...
        TD(TD_CC_CV),     OSM(MOD_LCTL),    KC_A,        KC_S,   KC_D,           KC_F,    KC_G,           KC_H,   KC_J,          KC_K,            KC_L,   KC_SCLN,         KC_QUOT,            KC_ENT,                   TD(TD_H_E),
        TD(TD_CD_CZ),     LGUI_T(KC_BSPC),               KC_Z,   KC_X,           KC_C,    KC_V,           KC_B,   TD(TD_CC_CV),  KC_N,            KC_M,   KC_COMM,         KC_DOT,   KC_SLSH,  TD(TD_LN_DEL),  KC_UP,
        MEH_T(KC_BSPC),   KC_ENT,           LCTL(KC_A),          OSM(MOD_LALT),  KC_SPC,  OSM(MOD_LSFT),                         LSFT_T(KC_SPC),          RCTL_T(KC_ESC),                      KC_LEFT,        KC_DOWN,  KC_RGHT),
